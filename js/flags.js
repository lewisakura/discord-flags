const flags = {
    ...
    BOT_HTTP_INTERACTIONS: {
        description: 'User is a HTTP interactions bot (hides status icon).',
        number: 1 << 19
    },
    SPAMMER: {
        description: 'User is a spammer and their account was banned by Discord\'s Trust and Safety team.',
        number: 1 << 20
    }
};
